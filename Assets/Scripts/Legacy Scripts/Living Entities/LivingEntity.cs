...
public class LivingEntity : MonoBehaviour
{
    ...
    [HideInInspector] public SpellBook mySpellBook;
    ...
    [HideInInspector] public int baseMobility;
    [HideInInspector] public int baseMaxHealth;
    [HideInInspector] public int baseStartingHealth;
    [HideInInspector] public int baseStamina;
    [HideInInspector] public int baseMaxEnergy;
    [HideInInspector] public int baseMeleeRange;
    [HideInInspector] public int baseStrength;
    [HideInInspector] public int baseWisdom;
    [HideInInspector] public int baseDexterity;
    [HideInInspector] public int baseInitiative;
    [HideInInspector] public int baseCriticalChance;
    [HideInInspector] public int baseDodgeChance;
    [HideInInspector] public int baseParryChance;
    [HideInInspector] public int baseAuraSize;
    [HideInInspector] public int baseStartingBlock;
    [HideInInspector] public int baseStartingEnergyBonus;
    [HideInInspector] public int baseMaxPowersCount;

    [Header("Base Resistance Properties")]
    [HideInInspector] public int basePhysicalResistance;
    [HideInInspector] public int baseFireResistance;
    [HideInInspector] public int baseFrostResistance;
    [HideInInspector] public int baseShadowResistance;
    [HideInInspector] public int basePoisonResistance;
    [HideInInspector] public int baseAirResistance;

    [Header("Current Trait Properties")]
    [HideInInspector] public int currentMobility;
    [HideInInspector] public int currentMaxHealth;
    [HideInInspector] public int currentHealth;
    [HideInInspector] public int currentMaxEnergy;
    [HideInInspector] public int currentStamina;
    [HideInInspector] public int currentEnergy;
    [HideInInspector] public int currentMeleeRange;
    [HideInInspector] public int currentStrength;
    [HideInInspector] public int currentWisdom;
    [HideInInspector] public int currentDexterity;
    [HideInInspector] public int currentInitiative;
    [HideInInspector] public int currentCriticalChance;
    [HideInInspector] public int currentDodgeChance;
    [HideInInspector] public int currentParryChance;
    [HideInInspector] public int currentAuraSize;
    [HideInInspector] public int currentMaxPowersCount;
    [HideInInspector] public int currentBlock;

    [Header("Current Resistance Properties")]
    [HideInInspector] public int currentPhysicalResistance;
    [HideInInspector] public int currentFireResistance;
    [HideInInspector] public int currentFrostResistance;
    [HideInInspector] public int currentShadowResistance;
    [HideInInspector] public int currentPoisonResistance;
    [HideInInspector] public int currentAirResistance;

    [Header("Weapon Properties")]
    [HideInInspector] public ItemDataSO myMainHandWeapon;
    [HideInInspector] public ItemDataSO myOffHandWeapon;

    [Header("Location Properties ")]
    [HideInInspector] public LevelNode levelNode;
    [HideInInspector] public Tile tile;
    [HideInInspector] public Point gridPosition;

    [Header("Pathfinding Properties ")]
    [HideInInspector] public Stack<Node> path;
    [HideInInspector] public Vector3 destination;

    [Header("Targetting Properties ")]
    [HideInInspector] public LivingEntity myCurrentTarget;
    [HideInInspector] public LivingEntity myTaunter;

    [Header("Combat State Properties ")]
    [HideInInspector] public int moveActionsTakenThisActivation;
    [HideInInspector] public int meleeAbilityActionsTakenThisActivation;
    [HideInInspector] public int skillAbilityActionsTakenThisActivation;
    [HideInInspector] public int rangedAttackAbilityActionsTakenThisActivation;
    [HideInInspector] public int timesMeleeAttackedThisTurnCycle;
    ...
    [HideInInspector] public bool myRangedAttackFinished;
    [HideInInspector] public bool hasActivatedThisTurn;
    [HideInInspector] public bool inDeathProcess;

    [Header("Mouse Input Properties ")]
    [HideInInspector] public bool mouseIsOverStatusIconPanel;
    [HideInInspector] public bool mouseIsOverCharacter;

    [Header("Miscealaneous Properties")]
    [HideInInspector] public string myName;
    [HideInInspector] public float movementAnimSpeed;
    ...
    public virtual void InitializeSetup(LevelNode location)
    {
        Debug.Log("Calling LivingEntity.InitializeSetup...");
    ...
    public virtual void SetBaseProperties()
    {
        ...
        if (defender)
        {
           ...
           // ModifyCurrentHealth(currentHealth);
    ...
    public virtual IEnumerator PlayMeleeAttackAnimation(LivingEntity entityMovedTowards, float speed = 3)
    {
       // PositionLogic.Instance.CalculateWhichDirectionToFace(this, entityMovedTowards.tile);
        ...
        // TO DO: reimplement attack movement anim here in future
        /*
    ...
    protected IEnumerator OnActivationStartCoroutine(OldCoroutineData action)
    {
        ...
        levelNode.SetActivatedViewState(true);
    ...
    public virtual void OnMouseEnter()
    {
        ...
        if (!inDeathProcess)
        {
            ...
            if(levelNode != null)
            {
                levelNode.SetMouseOverViewState(true);
            }
        }        
    }
    public virtual void OnMouseExit()
    {
        ...
        if (!inDeathProcess)
        {
            ...
            if (levelNode != null)
            {
                levelNode.SetMouseOverViewState(false);
            }
